...
function buildTodoItem(todo) {
  ...
  checkBtn.className = 'check-circle ' + (todo.completed ? 'check-circle--checked' : 'check-circle--empty');
  checkBtn.setAttribute('aria-label', todo.completed ? 'Mark as not completed' : 'Mark as completed');
  ...
  delBtn.innerHTML = '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" fill-rule="evenodd" d="M16.97 0l.708.707L9.546 8.84l8.132 8.132-.707.707-8.132-8.132-8.132 8.132L0 16.97l8.132-8.132L0 .707.707 0 8.84 8.132 16.971 0z"/></svg>';
